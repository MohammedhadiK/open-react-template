        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
              Hear from our dedicated community about the transformative education offered at WEFI Institute.
            </p>
          </div>
          <div className="flex justify-center pb-4 md:pb-12 hidden" data-aos="fade-up">
            <Image
              className="max-w-none"
              src={FeaturesImage}
              width={1104}
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                Our carefully designed curriculum covers all essential topics with a focus on practical, real-world applications.
              </p>
            </article>
            <article>
              <svg
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Engage in hands-on projects and collaborative learning experiences with peers.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Earn recognized certifications upon course completion to boost your career prospects.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Study at your own pace with our flexible learning schedules and online resources.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Get assistance with resume building, interview preparation, and job placement.
              </p>
            </article>
          </div>
        </div>
