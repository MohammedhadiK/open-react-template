...
const testimonials = [
  {
    ...
    content:
      "WEFI Institute has transformed my learning experience. The teachers are incredibly supportive and the curriculum is both challenging and engaging. I've seen a significant improvement in my grades and confidence.",
    categories: [1, 2],
  },
  {
    ...
    name: "Mohammed Ali",
    company: "Parent of Grade 8 Student",
    content:
      "As parents, we're extremely satisfied with the Islamic environment and academic excellence at WEFI. Our son has shown remarkable progress in both deen and dunya studies. The teachers truly care about each student's success.",
    categories: [1, 3],
  },
  {
    ...
    name: "Fatima Khan",
    company: "Alumna, Class of 2022",
    content:
      "The foundation I received at WEFI Institute prepared me exceptionally well for university. The critical thinking skills and Islamic values I learned continue to guide me in my higher education journey.",
    categories: [1, 4],
  },
  {
    ...
    name: "Yusuf Abdullah",
    company: "Grade 9 Student",
    content:
      "I love the hands-on learning approach at WEFI. The teachers make even complex topics easy to understand. The extracurricular activities have helped me discover my passion for robotics and programming.",
    categories: [1, 2],
  },
  {
    ...
    name: "Amina Hussein",
    company: "Parent of Grade 5 Student",
    content:
      "We chose WEFI for its strong Islamic values and academic rigor. The school has exceeded our expectations in nurturing both our daughter's faith and intellectual growth. The communication with teachers is excellent.",
    categories: [1, 3],
  },
  {
    ...
    name: "Ibrahim Malik",
    company: "Quran Teacher",
    content:
      "Teaching at WEFI has been a rewarding experience. The students are eager to learn, and the administration is supportive of innovative teaching methods that make Islamic education relevant to modern times.",
    categories: [1, 5],
  },
];
